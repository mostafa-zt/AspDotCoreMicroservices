...
namespace Catalog.API.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<IEnumerable<Product>> GetProductCategory(string catgeory)
        {
            FilterDefinition<Product> filter = Builders<Product>.Filter.Eq(p => p.Category, catgeory);
            return await _context.Products.Find(filter).ToListAsync();
        }
